...
# ------------------- Các phép biến đổi (không còn ảnh xám) ------------------- #
def rotate(img):
...
# Danh sách hàm tăng cường (loại bỏ to_gray)
AUG_FUNCS = [rotate, flip, color_jitter, add_noise]

# ------------------- Tăng cường ảnh ------------------- #
def augment_images(folder_path, target_total, size=224):
...
def main():
    ...
    augment_images(folder_path, target, size=224)  # CHỈNH KÍCH THƯỚC VỀ 224
